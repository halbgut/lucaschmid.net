...
module.exports = function (routes) {
  return routes.map(function (params, route) {
    return [route.replace(/{(\w)\*}/g, function (match) {
      ...
      view(params[0]).then(function (template) {
        template();
        container.innerHTML = '';
      }).catch(reload);
    }];
...
},{"../../../common/lib/parallelPromise":6}],3:[function(require,module,exports){
'use strict';
...
},{"./lib/nav":3,"riot/riot.min.js":8}],6:[function(require,module,exports){
'use strict';
